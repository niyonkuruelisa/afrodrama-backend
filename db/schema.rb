...
ActiveRecord::Schema.define(version: 2021_02_19_163604) do
  ...
  create_table "subscriptions", id: :string, limit: 36, force: :cascade do |t|
    ...
    t.datetime "period_from", precision: 6, null: false
    t.datetime "period_to", precision: 6, null: false
    t.string "status", default: "active"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "users", id: :string, limit: 36, force: :cascade do |t|
    ...
    t.string "user_region", default: ""
    t.string "user_country", default: ""
    t.string "user_timezone", default: ""
    t.string "user_location", default: ""
  end
